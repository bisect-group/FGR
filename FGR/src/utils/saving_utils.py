...
from main_code.FGR.src.utils import pylogger
...
def save_predictions(
    ...
    if output_format not in ("json", "csv"):
        raise NotImplementedError(
            ...
            "Or change `code.FGR.src.utils.saving.save_predictions` func logic."
        )
    ...
    raise Exception(
        ...
        "Or change `code.FGR.src.utils.saving.save_predictions` function logic."
    )
